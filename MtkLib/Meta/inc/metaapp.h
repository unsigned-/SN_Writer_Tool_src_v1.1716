...
typedef enum
{
    ...
    TOTAL_5_ADC_NUM = TOTAL_6205B_ADC_NUM,
    TOTAL_ADC_NUM_6 = 6,
    TOTAL_6_ADC_NUM = TOTAL_ADC_NUM_6,
    TOTAL_6218B_ADC_NUM = 7,
    TOTAL_7_ADC_NUM = TOTAL_6218B_ADC_NUM,
    TOTAL_ADC_NUM_8 = 8,
    TOTAL_8_ADC_NUM = TOTAL_ADC_NUM_8,
    TOTAL_ADC_NUM_9 = 9,
    TOTAL_9_ADC_NUM = TOTAL_ADC_NUM_9,
    TOTAL_ADC_NUM_13 = 13,
    TOTAL_ADC_NUM_MAX = TOTAL_ADC_NUM_13,
    TOTAL_13_ADC_NUM = TOTAL_ADC_NUM_13,
    MAX_ADC_NUM = TOTAL_ADC_NUM_MAX
} TOTAL_ADC_NUM_E;
...
typedef enum
{
    ...
    METAAPP_AUDIO_GAIN_TABLE_MISMATCH_WITH_NVDB,
} METAAPP_RESULT;

typedef METAAPP_RESULT E_METAAPP_RESULT_T;
